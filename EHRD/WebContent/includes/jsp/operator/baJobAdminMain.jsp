...
<head>
    ...
    function fn_detailView(jobLdrNum){
	 ...
	 function compListCheckBox(cmpNumber,obj){
		 ...
		 //전체 행동지표를 sort하는 소스 (선택된역량에 해당하는 행동지표만 나오도록 수정 2014.12.14)
	  ...
	  function buttonEvent(){
	       	...
	       	$("#delBtn").click( function(){
	            ...
	            if(isDel){ //직무삭제 영역
	        		...
	        		//직무삭제가 올바르게 이루어 졌다면 역량 행동지표 삭제 , 역량이 없다면 직무만 삭제
	        		if(delJob == "Y" && $('#compMapGrid').data('kendoGrid').dataSource.data().length > 0){ 
	        			//로딩바생성.
	                 	loadingOpen();
	    		 		var params = {
		...
		//save btn add click event
     		...
     		var isDel = confirm("직무정보를 저장하시겠습니까?");
		 	 if(isDel){
		 		//로딩바생성.
             	loadingOpen();
		 		var params = {
...
<body>
	<div id="excel-upload-window" style="display:none; width:320px;">
		<form method="post" action="<%= architecture.ee.web.util.ServletUtils.getContextPath(request) %>/operator/ba/ba_job_excel_upload.do?" >
		<input type ="hidden" name="jobFlag" value="J">
	       <div>
	...
	<!-- START MAIN CONTNET -->
	    ...
	    <div id="content">
        <div class="cont_body">
            <div class="title mt30">직무관리</div>
			<div class="table_tin01">
                <div class="px">※ 직무 정보를 추가, 수정할 수 있습니다.</div>
            </div>
            <div class="table_zone" >
                <div class="table_btn">
               		...
               		<a class="k-button"  href="<%= architecture.ee.web.util.ServletUtils.getContextPath(request) %>/operator/ba/ba_job_list_excel.do?jobFlag=J" >엑셀 다운로드</a>&nbsp;
	...
	<footer>
	 	...
	 	<script type="text/x-kendo-template"  id="template"> 
				...
				<table class="tabular" id="tabular" width="100%" cellspacing="0" cellpadding="0">
			    	...
			    	<tr>
				    	<td width="100px" class="subject" ><span style="background:url(/images/ico/ico_rec01.gif) no-repeat 0 6px">&nbsp;</span> 직무명 <span style="color:red">*</span> </td>
				    	<td><input type="text" id="jobLdrName" data-bind="value:JOBLDR_NAME" style="width:96%;" onKeyUp="chkNull(this);" />
					...
					<tr>
				    	<td width="100px" class="subject" ><span style="background:url(/images/ico/ico_rec01.gif) no-repeat 0 6px">&nbsp;</span> 사내직무코드  </td>
				    	<td><input type="text" id="comJobCd" data-bind="value:COMPANY_JOB_CD" style="width:96%;" onKeyUp="chkNull(this);" /></td>
			    	</tr>
			    	<tr>
				    	<td width="100px" class="subject" ><span style="background:url(/images/ico/ico_rec01.gif) no-repeat 0 6px">&nbsp;</span> 직무정의</td>
				    	<td><textarea rows="13"  type="text" id="jobLdrComment" data-bind="value:JOBLDR_COMMENT" style=" width:96%;" /></td>
			    	</tr>
					<tr>
				    	<td width="100px" class="subject" ><span style="background:url(/images/ico/ico_rec01.gif) no-repeat 0 6px">&nbsp;</span> 주요업무</td>
                    ...
                    <div>
						...
						<!-- 역량매핑 -->
                        <div id="compMapGrid" style="overflow-y:auto;" ></div>
